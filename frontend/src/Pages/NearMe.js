        ...
        <div className='p-3 container'>
            ...
            <div className='container'>
                {proffesional.map((chat) => {
                    if (selectedLocation === null || selectedLocation === chat.location && user !== null) { // Check if location is null or matches professional's location
                        return (
                            <div className="card my-4" key={chat.id} onClick={showModal}>
